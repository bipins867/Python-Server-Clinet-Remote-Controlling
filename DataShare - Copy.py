...
class Recv:
    ...
    def __init__(self,location='C:\\Users\\Bipin\\Documents\\DataStorage\\',chunk=1024*1024):
        try:
    ...
    def get(self,s,start,end='<-$-__(@#%^&*)__-$->'):
        ...
        while True:
            ...
            #print(d)
            #print(end)
            #print(cond,ms2.check_word(d,end))
            #print(cond,ms2.check_word(d,end))
            scond=str(cond)
...
class Send:
    ...
    def get_file_name(self,file):
        ...
        if index==None:
            ...
            return fName
    def send_file(self,s,file,start,end='<-$-__(@#%^&*)__-$->',chunk=1024):
        tstart=start
        tend=end
